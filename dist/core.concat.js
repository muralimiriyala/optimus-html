  ...
  ((e = (function () {
    ...
    return function (t, o) {
      ...
      (n.defaults = {
        ...
        asNavFor: null,
        prevArrow:
          '<button tabindex="0" type="button" class="slick-prev" aria-label="Previous" type="button">Previous</button>',
        nextArrow:
          '<button tabindex="0" type="button" class="slick-next" aria-label="Next" type="button">Next</button>',
        autoplay: !1,
        autoplaySpeed: 3e3,
        centerMode: !1,
        centerPadding: '50px',
        ...
        customPaging: function (e, t) {
          return i('<button tabindex="0" type="button" type="button" />').text(
            t + 1
          );
        },
        dots: !1,
  ...
  if (sublinks.length > 0) {
    sublinks.forEach(function (sublink) {
      sublink.addEventListener('click', function (e) {
        ...
        let targetSubSlide = document.querySelector(
          `.sub-service-slide[data-sub-service="${subslideno}"]`
        );
        if (targetSubSlide) {
